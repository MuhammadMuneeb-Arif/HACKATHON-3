...
const Cart = () => {
  return (
    <><Navbar /><div className="bg-[#F9F9F9]">
      <div className="bg-[#F9F9F9] w-full max-w-[1440px] px-auto items-center justify-center sm:px-10 lg:px-40 pt-10 pb-16 h-auto text-custom-purple">
